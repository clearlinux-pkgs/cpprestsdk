...
Source0  : https://github.com/Microsoft/cpprestsdk/archive/v2.10.12.tar.gz
...
%prep
%setup -q -n cpprestsdk-2.10.12
cd ..
%setup -q -T -D -n cpprestsdk-2.10.12 -b 1
mkdir -p Release/libs/websocketpp
cp -r %{_topdir}/BUILD/websocketpp-0.8.1/* %{_topdir}/BUILD/cpprestsdk-2.10.12/Release/libs/websocketpp
...
export LANG=C
export SOURCE_DATE_EPOCH=1555437753
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/cpprestsdk/cpprestsdk-targets-relwithdebinfo.cmake
